...
// Full mock data for all 10 hotels with expanded descriptions (each at least 5 sentences)
const mockHotels = [
    {
        id: 1,
        name: 'Cozy Cat Inn',
        ...
        amenities: ['24/7 CCTV Monitoring', 'Daily Playtime Sessions', 'Climate-Controlled Rooms', 'Personalized Grooming', 'Custom Meal Plans'],
        contact: { phone: '+84 28 3822 1234', email: 'info@cozycatinn.com' },
        rooms: [
            { type: 'Standard Room', price: 500000, description: 'Cozy room with basic amenities for one cat.' },
            { type: 'Luxury Suite', price: 750000, description: 'Spacious suite with extra play area and window view.' },
        ],
        reviews: [
            { user: 'Cat Lover Jane', rating: 5, comment: 'Amazing place! My cat loved it.' },
            { user: 'Perry', rating: 4, comment: 'Good service, but a bit pricey.' },
        ],
    },
    {
        id: 2,
        ...
        rooms: [
            { type: 'Economy Room', price: 350000, description: 'Affordable room with essential care.' },
            { type: 'Deluxe Room', price: 500000, description: 'Upgraded with more space and toys.' },
        ],
        reviews: [
    ...
    },
    {
        ...
        rooms: [
            { type: 'Playful Suite', price: 600000, description: 'Extra large play zone with tunnels and trees.' },
            { type: 'Standard Play Room', price: 480000, description: 'Cozy room with basic climbing equipment.' },
        ],
        reviews: [
    ...
    },
    {
        ...
        amenities: ['Private Suites', 'Natural Daylight', 'Daily Grooming', 'Medication Administration', 'Regular Photo Updates'],
        contact: { phone: '+84 24 3724 5678', email: 'stay@felineparadise.vn' },
        rooms: [
            { type: 'Deluxe Suite', price: 450000, description: 'Premium suite with window view and soft bedding.' },
            { type: 'Premium Suite', price: 650000, description: 'Larger space with extra grooming area.' },
        ],
        reviews: [
            { user: 'Hanoi Cat Mom', rating: 5, comment: 'My cat felt so relaxed here!' },
            { user: 'Lan', rating: 4.8, comment: 'Professional and caring staff.' },
        ],
    },
    {
        id: 5,
        ...
        amenities: ['Quiet & Soundproof Rooms', 'Gentle Handling', 'Hiding Spots', 'Calming Environment', 'Senior Cat Care'],
        contact: { phone: '+84 24 3825 4321', email: 'hello@cathavenhanoi.com' },
        rooms: [
            { type: 'Quiet Retreat Room', price: 300000, description: 'Peaceful space for calm or senior cats.' },
        ],
        reviews: [
            { user: 'Senior Cat Owner', rating: 4, comment: 'Perfect for my older cat.' },
            { user: 'Trang', rating: 4.2, comment: 'Very attentive and gentle staff.' },
        ],
    },
    {
        id: 6,
        ...
        amenities: ['West Lake Views', 'Luxury Suites', 'Elevated Perches', 'Concierge Service', 'Daily Photo Reports'],
        contact: { phone: '+84 24 3718 9999', email: 'royal@pawpalace.vn' },
        rooms: [
            { type: 'Royal Suite', price: 700000, description: 'Premium suite with lake view and luxury amenities.' },
            { type: 'Elite Suite', price: 900000, description: 'Largest space with private balcony area.' },
        ],
        reviews: [
            { user: 'Lake View Cat Lover', rating: 5, comment: 'My cat enjoyed the view so much!' },
            { user: 'Hoang', rating: 4.9, comment: 'Feels like a five-star hotel for cats.' },
        ],
    },
    {
        id: 7,
        ...
        amenities: ['Sea Breeze Rooms', 'Secure Garden Access', 'Bright & Airy Design', 'Supervised Outdoor Time', 'Daily Photo Updates'],
        contact: { phone: '+84 236 395 6789', email: 'beach@catretreatdanang.vn' },
        rooms: [
            { type: 'Ocean View Room', price: 400000, description: 'Bright room with sea breeze and garden access.' },
            { type: 'Beach Suite', price: 580000, description: 'Spacious suite with extra lounging space.' },
        ],
        reviews: [
            { user: 'Coastal Cat Parent', rating: 4.8, comment: 'The sea air was perfect for my cat!' },
            { user: 'Ngoc', rating: 4.5, comment: 'Very relaxing place near the beach.' },
        ],
    },
    {
        id: 8,
        ...
        rooms: [
            { type: 'Modern Room', price: 320000, description: 'Clean and ventilated room with river view.' },
            { type: 'Premium Room', price: 450000, description: 'Upgraded space with extra climbing features.' },
        ],
        reviews: [
            { user: 'River Cat Owner', rating: 4.2, comment: 'Great location and clean rooms.' },
            { user: 'Duy', rating: 4.0, comment: 'Staff were friendly and attentive.' },
        ],
    },
    {
        id: 9,
        ...
        amenities: ['Mountain Views', 'Natural Light Rooms', 'Soft Music', 'Stress-Reduction Activities', 'Daily Updates'],
        contact: { phone: '+84 236 371 9876', email: 'peace@mountainviewcat.vn' },
        rooms: [
            { type: 'Tranquil Suite', price: 550000, description: 'Spacious room with mountain view and calming features.' },
            { type: 'Zen Room', price: 700000, description: 'Extra quiet space with enhanced enrichment.' },
        ],
        reviews: [
            { user: 'Calm Cat Lover', rating: 5, comment: 'The quietest and most peaceful stay ever.' },
            { user: 'Hien', rating: 4.9, comment: 'Perfect for my anxious cat.' },
        ],
    },
    {
        id: 10,
        ...
        amenities: ['Modern Design', 'Interactive Play Zones', 'Vertical Climbing Space', 'Urban Convenience', 'Daily Fresh Meals'],
        contact: { phone: '+84 28 3740 5678', email: 'urban@cat-oasis.vn' },
        rooms: [
            { type: 'City Lounge Room', price: 380000, description: 'Stylish room with modern lounging and play features.' },
            { type: 'Trendy Suite', price: 520000, description: 'Premium space in Thao Dien style.' },
        ],
        reviews: [
            { user: 'Thao Dien Cat Parent', rating: 4.3, comment: 'Very stylish and fun for my cat!' },
            { user: 'Alex', rating: 4.1, comment: 'Convenient location and modern setup.' },
        ],
    },
];
...
export default function HotelDetailPage({ params }: { params: { id: string } }) {
    ...
    const handleBook = () => {
        alert(`Booked ${selectedRoom} from ${selectedDates.start} to ${selectedDates.end}!`);
    };

    const handleAddReview = () => {
        setReviews([...reviews, { user: 'You', rating: newReview.rating, comment: newReview.comment }]);
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md mb-8">
                    ...
                    <iframe
                        ...
                        src={`https://www.google.com/maps/embed/v1/search?q=${encodeURIComponent(hotel.location)}&key=YOUR_GOOGLE_MAPS_API_KEY`}
